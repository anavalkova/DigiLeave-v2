...
/**
 * @param {{ id, userName, userEmail, startDate, endDate, type, totalDays, requestDate, status }[]} requests
...
export default function ApproverView({ requests, loading, onApprove, onReject }) {
  if (loading) {
    return <p className="text-sm text-gray-500 py-8 text-center">Loading pending requests…</p>
  }
